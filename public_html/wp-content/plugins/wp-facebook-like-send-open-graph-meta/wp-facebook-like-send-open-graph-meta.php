				...
				<div id="side-sortables" class="meta-box-sortables">
					...
					<div id="about" class="postbox">
						...
						<div class="inside">
							...
							<span><a href="http://twitter.com/Triptrippertips" title="Follow us on Twitter" target="_blank"><img style="border:0px #ccc solid;" src="<?php echo plugins_url(); ?>/wp-facebook-like-send-open-graph-meta/images/twitter-icon.png" /></a></span>
						</div><!-- .inside -->
					</div><!-- #about.postbox -->
