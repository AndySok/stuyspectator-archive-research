...
<!-- LOGO AND BANNER -->
		...
		<a name="top"></a>
                <td align="center" valign="bottom"><img src="images/header.gif"></td>
...
sub leftnavtable{
    ...
    <!-- LEFT NAVBAR-->
	<table width="110" border="1" cellspacing="0" cellpadding="5" height="200" class="menu">
                    <tr>       
                      <td align="left" valign="top" width="110" height="150" bgcolor="$leftbarcolor" class="menu"> 
		        <h1 class = "menu">In The Paper</h1><br>
