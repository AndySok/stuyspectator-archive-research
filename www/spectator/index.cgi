...
###############
    ...
    &col1_start(350);
print qq|<img src="specfront.jpg" border="0">|;
...
<!-- RECENT HEADLINES -->
		   <table width="270" border="0.5" cellspacing="0" cellpadding="0" class="content">
		    <tr> 
		     <td width="270" bgcolor="orange"> 
...
<!-- SCOREBOARD -->
	       <td width="129" align="left" valign="top">
	        ...
	        <table width="129" border="0.5" cellspacing="0" cellpadding="1" class="content">
		  <tr>
