...
|
*/
$config['base_url']	= "http://stuyspectator.com/pasteup2/";
...
|
*/
$config['encryption_key'] = "hZO81F7HwlmJ7vb0OnlViaEEtnps1YW";
...
|
*/
$config['sess_cookie_name']		= 'spec_session';
$config['sess_expiration']		= 7200;
$config['sess_encrypt_cookie']	= FALSE;
$config['sess_use_database']	= TRUE;
$config['sess_table_name']		= 'spec_sessions';
