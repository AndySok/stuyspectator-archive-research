...
class CI_Input {
	...
	function xss_clean($str, $charset = 'ISO-8859-1')
	{
		 ...
		 *
		 * This is a custom addition to the input class added by sam.
		 * I added it to fix the problem we were having where "curly"
		 * quotes were coming up null.
		 *
		 */
		
		 $search = array(chr(145),chr(146),chr(147),chr(148), '…', chr(39));  
		 // OR   $search = array('‘','’','“','”');  the last two were added by sam, 2nd to last is obvious, last = '  
