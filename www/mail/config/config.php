...
$language_module = "english-usa.inc";

# what is your Mysql database server
$database_host = "localhost";

# what is the name of the database we are using
$database_name = "stuyspec_plst1";

# who do we log in as?
$database_user = "stuyspec_plst1";

# and what password do we use
$database_password = 'VyJ3VIbXb25Q';
...
$bounce_mailbox_host = 'stuyspectator.com';
$bounce_mailbox_user = 'stuyspec';
$bounce_mailbox_password = 'b4dpr3ss';
...
$commandline_users = array("<REMOTEUSER>");
...
$stats_collection_address = 'victor@stuyspectator.com';
...
define("TINYMCEOPTS", ",relative_urls:false,remove_script_host:false");
...
$attachment_repository = '/home/stuyspec/public_html/mail/attachments';
...
#$strInvalidDomainInEmail = "Please email victor@stuyspector.com to be added to the list or try using a different email address.";
#$banned_domains = array("yandex.ru",); 
